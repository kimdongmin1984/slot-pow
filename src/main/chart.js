...
const dateFormat = timeFormat("%H:%M:%S");
...
class CandleStickChartWithHoverTooltip extends React.Component {
  ...
  render() {
    ...
    const margin = { left: 0, right: 80, top: 30, bottom: 50 };
    ...
    return (
      ...
      >
        ...
        >
          ...
          <CandlestickSeries
            fill={(d) => (d.open - d.close < 0 ? "#ff0000" : "#1261c4")} // Apply Red and Green
          />
          ...
          <EdgeIndicator
            ...
            edgeAt="right"
            yAccessor={(d) => d.close}
            fill={(d) => (d.close > d.open ? "#ff0000" : "#FF0000")}
          />
